...
function homeTeamName() {
 ...
 const numPointsScored = (playerName) => {
    ...
    for(const gameKey in game){
        ...
        for(const teamKey in teamObj){
            let playerObj = teamObj[teamKey]
                ...
                for(const playerKey in playerObj){
                    let pointsObj = playerObj[playerKey]
                    if(playerKey === playerName){
                        pointScored = playerObj[playerKey].points
                        // for(const pointsKey in pointsObj){
                            // if(pointsKey === "points"){
                                // pointScored = `${pointsKey}: ${pointsObj[pointsKey]}`
                            // }
                        // }
                    }
                }
        ...
        // if (typeof object[teamName] === "players") {
        //     console.log("Test" + object[teamName][nestedKey]);
        //     for (const nestedKey in object[teamName]) {
        //         console.log("Test" + object[teamName][nestedKey]);
        //     }
        // }
    }
